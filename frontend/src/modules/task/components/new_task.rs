use yew::prelude::*;
use crate::{modules::shared::components::{Checkbox, Switch}, TaskType};
use serde_json;
use gloo::{self, console::log};
use wasm_bindgen::JsCast;
use web_sys::HtmlInputElement;
use chrono::Weekday::{Fri, Mon, Sat, Sun, Thu, Tue, Wed, self};
...
pub fn new_task() -> Html {
    ...
    log!(serde_json::to_string_pretty(&*selected_week_days).unwrap());
    ...
    html!{
        <div class="view-container">
          <div class="text-xl font-bold w-4/5" >{"Task name"}</div>
                ...
                if *task_type == TaskType::HABIT {
                    ...
                    if *have_date {
                        <div class="text-l w-4/5 flex mb-5 justify-center" >
                            <input id="startDate" onchange={on_change_date} class="form-control" type="date" />
                        </div>
                    }
                    </>
                }
            ...
            <button class="mdc-button mdc-button--raised w-4/5">
